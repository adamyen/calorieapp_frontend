...
# BurnOut
BurnOut is easy to use to application that keeps track for user's daily calories gain and loss. It can help user to set goals such as weight loss/gain. This document provides a major perspective for the users to understand and take up the project as an Open source software and add on multiple features before releasing to the market. Also, the document aids the developers in understanding the code and acts as a reference point for continuing the project. 
